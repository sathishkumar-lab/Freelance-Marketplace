...
if (isset($_POST['bid'])) {
    ...
    if (move_uploaded_file($_FILES["resume"]["tmp_name"], $target_file)) {
        ...
        if ($stmt->execute()) {
            echo "<script>alert('Bid placed successfully!'); window.location.href='posts.php';</script>";
        } else {
    ...
    <div id="bidModal" class="modal">
        <div class="modal-content">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <button type="submit" name="bid" class="back-btn" style="border:none; font-size:20px;" >Place Bid</button>
            </form>
        </div>
</div>
